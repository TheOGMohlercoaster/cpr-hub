...
const IPHONE_DATA = [
  ...
  { model: 'iPhone 15 Plus', port: 'usbc', home: false, cameras: 2, layout: 'vertical', front: 'island', action: false, colors: ['Black', 'Yellow', 'Green', 'Pink', 'Blue'] },
  { model: 'iPhone 15', port: 'usbc', home: false, cameras: 2, layout: 'vertical', front: 'island', action: false, colors: ['Black', 'Yellow', 'Green', 'Pink', 'Blue'] },
